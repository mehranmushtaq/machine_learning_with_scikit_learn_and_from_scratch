...
* **Observation**: Unlike classification where we measure accuracy, in regression, these constraints directly impact the Mean Squared Error (MSE) and \bm{R^2} score.
...
* **\bm{R^2} Score (Coefficient of Determination)**: Represents the proportion of variance for the target variable that's explained by the independent variables. Our test \bm{R^2} achieved approximately 0.41.
