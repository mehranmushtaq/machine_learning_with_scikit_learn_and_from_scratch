...
### [Disease Prediction Pipeline](./Projects/disease_prediction_pipeline/)

> *NovaGen Research Labs · 9,800 patients · Voting Classifier Ensemble*

Classifies individuals as healthy or unhealthy using a full ensemble pipeline (Logistic Regression + Random Forest + Naïve Bayes). Achieved **94.89% accuracy** and **95.46% CV recall** — production-ready for clinical trial participant selection.

-----

### [E-Commerce Purchase Prediction](./Projects/ecommerce-purchase-prediction/)

> *12,330 sessions · Decision Tree · F1-Score benchmark: 0.55*

Predicts whether an online visitor will convert to a buyer. Tackled heavy class imbalance (85/15 split) with `class_weight='balanced'` and pruning strategies. Achieved **F1-Score: 0.6485** — beating the benchmark by 18%.

-----

### [CreditWise Loan Approval System](./Projects/CreditWise%20Loan%20System/)
...
cd Machine-Learning-with-scikit-learn-and-from-scratch
